    ...
    <section class="wrapper">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form method="post" action="<?= base_url("admin/halaman/do_edit_tunggal")?>" enctype="multipart/form-data">
                    <div class="row">
                        <div class=" col-lg-12">
                            <label>Tanggal</label>
                            <input type="text" class="form-control default-date-picker" name="tanggal"
                                value="<?= date_format(date_create($tunggal->tanggal), 'd-m-Y');?>" />
                    ...
                    <div class="form-group">
                        <label>Isi</label>
                        <textarea class="form-control ckeditor" name="isi" rows="12"><?= $tunggal->isi?></textarea>
                    </div>
                    <div class="form-group">
