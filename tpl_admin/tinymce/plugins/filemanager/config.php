...
$base_url="http://dispenda.agsatu.com/"; //url base of site if you want only relative url leave empty
$upload_dir = '/gambar/'; // path from base_url to upload base dir
$current_path = '../../../../gambar/'; // relative path from filemanager folder to upload files folder
